...
- **Meal planner** [Demo (deactivated atm)](https://app.nutri.demo.nihiluis.com/?id=2177a6bf-7af5-4a62-86b2-104d1967517d&mealSize=100&weight=60&focus=keep&activityLevel=low): helper for creating healthy recipes based on nutrient data (node.js, GraphQL Pothos + Prisma, Next), Authelia login (user: demo, pw: b3zQN5pBIGOGDBu)
